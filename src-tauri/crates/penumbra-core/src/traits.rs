...
impl<R: std::io::Read + Send> Reader for R {}

pub trait Writer: std::io::Write + Send {}
impl<W: std::io::Write + Send> Writer for W {}

pub trait ReaderSource<R: Reader>: FnMut(&str) -> crate::Result<(R, usize)> + Send {}
impl<R: Reader, F: FnMut(&str) -> crate::Result<(R, usize)> + Send> ReaderSource<R> for F {}

pub trait WriterSink<W: Writer>: FnMut(&str) -> crate::Result<W> + Send {}
impl<W: Writer, F: FnMut(&str) -> crate::Result<W> + Send> WriterSink<W> for F {}
