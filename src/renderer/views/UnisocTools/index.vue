  ...
  <div class="unisoc-tools">
    ...
    <div class="tools-section">
      ...
      <div class="tools-grid">
        <div class="tool-card" @click="openPacFlasher">
          <div class="tool-icon">
          ...
          <div class="tool-name">PAC Flasher</div>
          <div class="tool-desc">Flash PAC firmware files</div>
        </div>
        <div class="tool-card" @click="openXmlFlasher">
          <div class="tool-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
          ...
          <div class="tool-name">XML Flasher</div>
          <div class="tool-desc">Flash via XML configuration</div>
        </div>
        <div class="tool-card" @click="openResearchDownload">
          <div class="tool-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
              <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" />
            </svg>
          </div>
          <div class="tool-name">Research Download</div>
          <div class="tool-desc">Use Research/Upgrade tool</div>
        </div>
      </div>
    </div>
    ...
    <div class="tools-section">
      ...
      <div class="tools-grid">
        ...
        <div class="tool-card" @click="diagMode">
          <div class="tool-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
              <path d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
            </svg>
          </div>
          <div class="tool-name">Diag Mode</div>
          <div class="tool-desc">Enter diagnostic mode</div>
        </div>
      </div>
    </div>
    ...
    <div class="tools-section">
      ...
      <div class="tools-grid">
        ...
        <div class="tool-card" @click="dumpPartitions">
          <div class="tool-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
              <path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4M7 10l5 5 5-5M12 15V3" />
            </svg>
          </div>
          <div class="tool-name">Dump Partitions</div>
          <div class="tool-desc">Dump all partitions</div>
        </div>
...
const openPacFlasher = () => sendIpcToMain('open-pac-flasher')
const openXmlFlasher = () => sendIpcToMain('open-xml-flasher')
const openResearchDownload = () => sendIpcToMain('open-research-download')

const forceFastboot = () => sendIpcToMain('unisoc-force-fastboot')
const forceRecovery = () => sendIpcToMain('unisoc-force-recovery')
const readInfo = () => sendIpcToMain('unisoc-read-info')
const diagMode = () => sendIpcToMain('unisoc-diag-mode')

const readPartitions = () => sendIpcToMain('unisoc-read-partitions')
const dumpPartitions = () => sendIpcToMain('unisoc-dump-partitions')
const erasePartition = () => sendIpcToMain('unisoc-erase-partition')

const unlockBootloader = () => sendIpcToMain('unisoc-unlock-bootloader')
const rootDevice = () => sendIpcToMain('unisoc-root')
const frpBypass = () => sendIpcToMain('unisoc-frp-bypass')
