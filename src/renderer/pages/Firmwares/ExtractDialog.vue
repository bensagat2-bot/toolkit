...
const isFrbox = computed(() => props.url.includes('/disk/s/') || props.url.includes('aliyundrive') || props.url.includes('pdsapi'))
const isTgz = computed(() => !isFrbox.value && (props.url.includes('.tgz') || props.url.includes('.tar.gz')))
