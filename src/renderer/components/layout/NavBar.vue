  ...
  <nav class="menu">
    <ul>
      <li v-for="item in menus" :key="item.to">
        <router-link
          :class="['link', { active: $route.name === item.name }]"
          :to="item.to"
        ...
        >
          ...
          >
            ...
            <line v-for="(l, i) in item.lines" :key="'l' + i" v-bind="l" />
            <rect v-for="(r, i) in item.rects" :key="'r' + i" v-bind="r" />
            <circle v-for="(c, i) in item.circles" :key="'c' + i" v-bind="c" />
            <polyline v-for="(p, i) in item.polylines" :key="'p' + i" :points="p" />
          </svg>
        </router-link>
      </li>
    </ul>
...
const menus: Array<{
  ...
  rects: Array<Record<string, string>>
  circles: Array<Record<string, string>>
  polylines: string[]
}> = [
  {
    to: '/mediatek',
    ...
    lines: [
      { x1: '9', y1: '1', x2: '9', y2: '5' },
      { x1: '15', y1: '1', x2: '15', y2: '5' },
      { x1: '9', y1: '19', x2: '9', y2: '23' },
      { x1: '15', y1: '19', x2: '15', y2: '23' },
      { x1: '1', y1: '9', x2: '5', y2: '9' },
      { x1: '1', y1: '15', x2: '5', y2: '15' },
      { x1: '19', y1: '9', x2: '23', y2: '9' },
      { x1: '19', y1: '15', x2: '23', y2: '15' },
    ],
    rects: [
  ...
  },
  {
    ...
    lines: [
      ...
      { x1: '1', y1: '9', x2: '4', y2: '9' },
      { x1: '1', y1: '15', x2: '4', y2: '15' },
      { x1: '20', y1: '9', x2: '23', y2: '9' },
      { x1: '20', y1: '15', x2: '23', y2: '15' },
    ],
    rects: [
  ...
  },
  {
    ...
    lines: [
      { x1: '3', y1: '3', x2: '7', y2: '3' },
      { x1: '3', y1: '8', x2: '7', y2: '8' },
      { x1: '3', y1: '13', x2: '7', y2: '13' },
      { x1: '3', y1: '18', x2: '7', y2: '18' },
      { x1: '13', y1: '3', x2: '21', y2: '3' },
      { x1: '13', y1: '8', x2: '21', y2: '8' },
      { x1: '13', y1: '13', x2: '21', y2: '13' },
      { x1: '13', y1: '18', x2: '21', y2: '18' },
    ],
    rects: [],
    circles: [],
    polylines: [],
  },
  {
    ...
    name: 'Backup',
    label: 'Backup',
    paths: ['M21 8l-9-5-9 5 9 5 9-5z'],
    lines: [
      { x1: '3', y1: '8', x2: '3', y2: '16' },
      { x1: '21', y1: '8', x2: '21', y2: '16' },
      { x1: '12', y1: '13', x2: '3', y2: '8' },
      { x1: '12', y1: '13', x2: '21', y2: '8' },
      { x1: '12', y1: '13', x2: '12', y2: '21' },
    ],
    rects: [],
    circles: [],
    polylines: [],
